...
use gstd::{prelude::*, msg, CodeId, ActorId, collections::BTreeMap, prog::ProgramGenerator};
...
impl TamagotchiFactory {
    ...
    pub async fn get_tamagotchi_name(&self, tamagotchi_id: TamagotchiId) {
        ...
        let tamagotchi_name_ans = Self::send_message(
            &tamagotchi_address,
            TmgAction::Name
        ).await;
        ...
        msg::reply(TamagotchiFactoryEvent::Name(tamagotchi_name), 0)
            .expect("Error sending reply");
    }
    
    pub async fn get_tamagotchi_age(&self, tamagotchi_id: TamagotchiId) {
        let tamagotchi_address = self.get_tamagotchi_address(tamagotchi_id);
        let tamagotchi_age_ans = Self::send_message(
            &tamagotchi_address,
            TmgAction::Age
        ).await;
        ...
        msg::reply(TamagotchiFactoryEvent::Age(tamagotchi_age), 0)
            .expect("Error sending reply");
    }
    ...
    pub async fn feed_tamagotchi(&self, tamagotchi_id: TamagotchiId) {
        ...
        msg::reply(TamagotchiFactoryEvent::Fed, 0)
            .expect("Error sending reply");
    }
    ...
    pub async fn play_with_tamagotchi(&self, tamagotchi_id: TamagotchiId) {
        ...
        msg::reply(TamagotchiFactoryEvent::Entertained, 0)
            .expect("Error sending reply");
    }
    ...
    pub async fn sleep_tamagotchi(&self, tamagotchi_id: TamagotchiId) {
        ...
        msg::reply(TamagotchiFactoryEvent::Slept, 0)
            .expect("Error sending reply");
    }
    ...
    pub async fn transfer_tamagotchi(&self, tamagotchi_id: TamagotchiId, new_owner: ActorId) {
        ...
        msg::reply(TamagotchiFactoryEvent::Transferred(new_owner), 0)
            .expect("Error sending reply");
    }
    ...
    pub async fn approve_user(&self, tamagotchi_id: TamagotchiId, user: ActorId) {
        ...
        msg::reply(TamagotchiFactoryEvent::Approved(user), 0)
            .expect("Error sending reply");
    }
    ...
    pub async fn revoke_approval(&self, tamagotchi_id: TamagotchiId) {
        ...
        msg::reply(TamagotchiFactoryEvent::ApprovalRevoked, 0)
            .expect("Error sending reply");
    }
    
    pub async fn set_ft_token_contract_to_tamagotchi(&self, tamagotchi_id: TamagotchiId, ft_token_contract: ActorId) {
        let tamagotchi_address = self.get_tamagotchi_address(tamagotchi_id);
        let tamagotchi_ans = Self::send_message(
            &tamagotchi_address,
        ...
        msg::reply(TamagotchiFactoryEvent::FTTokenContractSet, 0)
            .expect("Error sending reply");
    }
    
    pub async fn approve_tokens_from(&self, tamagotchi_id: TamagotchiId, account: ActorId, amount: u128) {
        let tamagotchi_address = self.get_tamagotchi_address(tamagotchi_id);
        let tamagotchi_ans = Self::send_message(
            &tamagotchi_address,
        ...
        if tamagotchi_ans == TmgEvent::ApprovalError {
            msg::reply(TamagotchiFactoryEvent::ApprovalError, 0)
                .expect("Error sending reply");
            return;
        }
        
        let correct_ans = TmgEvent::TokensApproved { 
            account, 
            amount
        };
        ...
        let response = TamagotchiFactoryEvent::TokensApproved { 
            account, 
            amount 
        };
    ...
    pub async fn buy_attribute_to_tamagotchi(&self, tamagotchi_id: TamagotchiId, store_id: ActorId, attribute_id: AttributeId) {
        let tamagotchi_address = self.get_tamagotchi_address(tamagotchi_id);
        let tamagotchi_ans = Self::send_message(
            &tamagotchi_address,
        ...
        if let TmgEvent::CompletePrevPurchase( prev_purchase ) = tamagotchi_ans {
            msg::reply(TamagotchiFactoryEvent::CompletePrevPurchase(prev_purchase), 0)
                .expect("Error sending reply");
            return;
        }
    ...
    pub async fn reserve_gas_to_tamagotchi(&self, tamagotchi_id: TamagotchiId, reservation_amount: u64, duration: u32) {
        let tamagotchi_address = self.get_tamagotchi_address(tamagotchi_id);
        let tamagotchi_ans = Self::send_message(
            &tamagotchi_address,
        ...
        msg::reply(TamagotchiFactoryEvent::GasReserved, 0)
            .expect("Error sending reply");
    }
    ...
    pub async fn send_message(
        ...
        msg::send_for_reply_as::<_, TmgEvent>(*tamagotchi_address, tamagotchi_payload, msg::value(), 0)
