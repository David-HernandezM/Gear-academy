...
impl AttributeStore {
    ...
    pub async fn update_attribute(&mut self, attribute_id: AttributeId) {
        ...
        let result = self.charge_attribute_improvement(transaction_id, attribute_id).await;
    ...
    pub async fn charge_attribute_improvement(
        &mut self, 
        transaction_id: TransactionId,
        attribute_id: AttributeId,
    ) -> bool {
    ...
    pub fn get_attributes(&self, tmg_id: &TamagotchiId) {
    ...
    pub fn remove_tx(&mut self, tmg_id: &TamagotchiId) {
        assert_eq!(
            msg::source(),
            self.admin,
